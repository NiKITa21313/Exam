...
namespace telecommunication_company.Pages
{
    ...
    public partial class Redactirovanie : Page
    {
        ...
        {
            string doljnost = "";
            if (s.ID_doljnosti == 1) doljnost = "Монтажник";
            if (s.ID_doljnosti == 2) doljnost = "Менеджер";
            if (s.ID_doljnosti == 3) doljnost = "Продавец-консультант";
            if (s.ID_doljnosti == 4) doljnost = "Администратор";
            return doljnost;
        }
        /// <summary>

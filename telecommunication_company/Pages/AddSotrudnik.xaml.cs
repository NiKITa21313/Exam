...
namespace telecommunication_company.Pages
{
    public partial class AddSotrudnik : System.Windows.Controls.Page
    {
        ...
        private void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            if (Doljnost(txbDoljnost.Text) != 0) sotrudnik.ID_doljnosti = Doljnost(txbDoljnost.Text);
        ...
        private void Dogovor() 
        {
            ...
            if (sotrudnik.ID_doljnosti == 1)
            {
                zarplata = "20000";
                zarplataSlovami = "Двадцать тысяч";
            }
            if (sotrudnik.ID_doljnosti == 2)
            {
                zarplata = "30000";
                zarplataSlovami = "Тридцать тысяч";
            }
            if (sotrudnik.ID_doljnosti == 3)
            {
                zarplata = "40000";
                zarplataSlovami = "Сорок тысяч";
            }
            if (sotrudnik.ID_doljnosti == 4)
            {
                zarplata = "50000";
            ...
            var items = new Dictionary<string, string>()//словарь с тегами из шаблона документа
                {
            ...
            Microsoft.Office.Interop.Word.Application wordApp = null;//инициализация приложения
            Document wordDoc;
            ...
            try
            {
                ...
                object fileName = "D:\\Проекты C#\\telecommunication_company\\telecommunication_company\\Files\\Dogovor.docx";
                ...
                object newFile = $"C:\\Users\\Никита\\Desktop\\Договоры\\{sotrudnik.Familiya}.docx";
